...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    <div>
        <label for="name" class="mb-2 block text-sm font-medium text-slate-700">
            Customer Group Name <span class="text-red-500">*</span>
        </label>
        <input
            type="text"
            id="name"
            ...
            placeholder="Example: Retail, Wholesale, VIP"
    ...
    <div>
        <label for="code" class="mb-2 block text-sm font-medium text-slate-700">
            Customer Group Code <span class="text-red-500">*</span>
        </label>
        <input
            type="text"
            id="code"
            name="code"
            value="{{ old('code', $customerGroup->code ?? '') }}"
            placeholder="Example: RET, WHL, VIP"
...
<div class="mt-8 flex items-center gap-3">
    <button
        ...
        {{ $buttonText ?? 'Save Customer Group' }}
    </button>
