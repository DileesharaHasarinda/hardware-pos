<x-layouts.admin>
    <x-slot name="title">Brands | Hardware POS</x-slot>
    ...
    <div class="space-y-6">
        <div class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
            <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h3 class="text-lg font-bold text-slate-900">Brand Master</h3>
                    <p class="mt-1 text-sm text-slate-500">Manage brand names and brand codes.</p>
                </div>
            ...
            <form method="GET" action="{{ route('admin.brands.index') }}" class="mt-6">
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-slate-200">
                    <thead class="bg-slate-50">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">Brand Name</th>
                            <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-wider text-slate-500">Brand Code</th>
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        @forelse($brands as $brand)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="px-6 py-4 text-sm font-medium text-slate-700">{{ $brand->code }}</td>
